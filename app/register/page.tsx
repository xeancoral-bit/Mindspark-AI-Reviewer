...
export default function Register() {
  ...
  return (
    <div className="min-h-screen bg-[#040406] flex items-center justify-center bg-grid-pattern px-6 relative">
      {/* Decorative glows */}
      ...
      <div className="w-full max-w-md bg-zinc-950/80 border border-zinc-900 rounded-3xl p-8 backdrop-blur-md shadow-2xl relative">
        ...
        <div className="flex flex-col items-center mb-8 text-center">
          ...
          <p className="text-zinc-500 text-sm mt-1">Get started with your gamified study tools</p>
        </div>
